...
Файлы документации в порядке приоритета. Если менее приоритетный файл противоречит более приоритетному — обязательно сообщить об этом пользователю и предложить внести корректив в один из файлов или в оба.

1. [Функциональные требования и глоссарий](docs/features.md)
2. [Конкретные требования](docs/requirements.md)
3. [Описание UI](docs/ui.md)
